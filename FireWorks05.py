...
class AmericanFlag:
    """Procedurally renders a stylized, dark-sky compatible American Flag backdrop."""
...
def run_show(canvas, fireworks, crackles, skyline, flashes, flag):
    ...
    # Render static background backdrop items first
    flag.draw()
    skyline.draw(canvas)
    ...
    # Update and render active elements
    for fw in fireworks[:]:
        fw.update()
        fw.draw()
...
# Places a stylized 300x160 pixel flag elegant in the top-left area
